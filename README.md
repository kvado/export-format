...
|date_to|Дата окончания регистрации|string|Возможные значения:<ul><li>Выехал</li><li>Умер</li><li>Окончание временной регистрации по месту пребывания</li><li>Выписан на основании решения суда</li><li>Утрата права собственности'</li><li>Иное</li><ul>
