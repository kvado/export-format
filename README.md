...
## Сведения о домах, помещениях, комнатах, лицевых счетах, собственниках, регистрациях
...
|beginning_values|Начальные показания на момент опломбирования|[Показания счетчиков](#type-meter-value)|См. тип [Показания счетчика](#type-meter-value)|
